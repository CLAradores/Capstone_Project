...
{{-- <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
  ...
  <div class="flex justify-center items-center mt-20 ">
      ...
      <button class="flex flex-end bg-green-500 rounded font-bold text-white hover:bg-green-300 p-2 mb-10"> <a href="/appointment">Book Appointment</a></button></div>
    <table class=" table-auto w-full text-sm text-center rtl:text-right text-gray-500 dark:text-gray-400  max-w-screen-2xl mx-auto ">
